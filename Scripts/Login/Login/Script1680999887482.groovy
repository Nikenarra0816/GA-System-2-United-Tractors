...
WebUI.setText(findTestObject('Login/field-username'), 'gdsechead')

WebUI.setEncryptedText(findTestObject('Login/field-password'), 'vDCxDdcVGQE=')
...
WebUI.setEncryptedText(findTestObject('Login/field-password'), 'n6NR8oDuwok=')
